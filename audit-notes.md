...
**Обновление (Этап 8, D-37):** решение отвязано от Этапа 7 в 7l. SP выключается последним окном Этапа 8 (8c-10)
по отдельной санкции Bao — после приёмки 8c и мержа в master.
...
## Этап 8 — сквозной аудит (8a), пакет фиксов (8b), живая приёмка (8c) — ✅ (2026-09-25; остаток — D-37, окно 8c-10)
...
- Долги: D-03 и D-29 ✅ 8c-5; D-06 ✅ 8c-7; D-31 ✅ 8c-8 / 8c-8b; D-36 ✅ этот коммит (чекбоксы §7 MASTER);
  D-17 — ПРИНЯТО (селфтест); D-37 — окно 8c-10.
...
`docs/stage8/security-checklist.md`, чекбоксы §7 заполнены. KNOWN_ISSUES §4 закрыт, §9 заведён. Остаток —
D-37 (System Protection off), отдельным последним окном 8c-10.
