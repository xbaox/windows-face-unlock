...
## Этап 8 — сквозной аудит (8a) и пакет фиксов (8b) (в работе)

> Улики: `C:\dev\d-series\8a\` (аудит: `8a-report.md`, `findings.md`, `debts.md`,
> `security-checklist.md`, `dod.md`, `proposals.md`, ZIP `4ABB25B8…AEDD85`) и
> `C:\dev\d-series\8b\` (фиксы, селфтесты, смоуки, отчёт). Номера F-NN и D-NN —
> из `findings.md` / `debts.md` 8a и действуют до конца Этапа 8.
